...
# uid = "oleg"
# fn = "{}.jpg".format(uid)
# vasya_image = face_recognition.load_image_file(fn)
...
uids = list(uids_with_faces_encodings.keys())
known_faces_encodings = list(uids_with_faces_encodings.values())
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            if min(face_distances) < 0.5:
                ...
                uid = uids[np.argmin(face_distances)]
                name = uid
            else:
                name = "Unknown"
